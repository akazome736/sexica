...
export default function DTPage() {
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col">
      <div className="flex-1 flex flex-col items-center px-4 pt-28 md:pt-40">
          ...
          <form onSubmit={handleSubmit} className="w-full max-w-xl mx-auto mb-8">
            <div className="relative flex items-center">
              <Input
                ...
                className="h-14 px-6 text-base bg-black/30 backdrop-blur-sm border-2 border-yellow-400/40 text-white placeholder:text-yellow-400/70 rounded-full focus-visible:ring-2 focus-visible:ring-yellow-400/60 focus-visible:ring-offset-2 focus-visible:ring-offset-black transition-all duration-300 hover:border-yellow-400/60 w-full font-sans font-normal tracking-wide placeholder:font-normal placeholder:tracking-normal"
              />
            </div>
          </form>
